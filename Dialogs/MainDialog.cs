        ...
        private async Task<DialogTurnResult> ActStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            switch (luisResult.TopIntent().intent)
            {
                case DoctorBooking.Intent.BookAppointment:
                    ...
                    if (!validDoctor)
                    {
                        return await stepContext.ReplaceDialogAsync(InitialDialogId, "Doctor Khaja, John and Afri are available?", cancellationToken);
                    }
                    ...
                    return await stepContext.BeginDialogAsync(nameof(AppointmentBookingDialog), AppointmentDetails, cancellationToken);
                ...
                case DoctorBooking.Intent.GetAvailableDoctors:
                    ...
                    var getAvailableDoctorsMessageText = "Doctor Afri, Doctor Khaja and Doctor John are available today ";
